...
`;
  ...
  private async generateTranslationTypes(): Promise<void> {
    ...
    const entries = Array.from(keys)
      ...
      .join("\n");
    const content = `// Auto-generated by Warlock.js - DO NOT EDIT
// Generated from groupedTranslations calls in discovered app source (locale
// files and register modules alike). Dynamic group names/keys cannot be
// resolved statically and are not included here — document those yourself.
