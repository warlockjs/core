 ...
 */
type MailConfigurations = SMTPConfigurations | SESConfigurations;
/**
 * Mail mode determines how emails are handled
 */
type MailMode = "production" | "development" | "test";
/**
 ...
 * ```
 */
type SMTPConfigurations = SMTPTransport.Options & {
  /**
 ...
 */
type MailErrorCode = "CONNECTION_ERROR" | "AUTH_ERROR" | "RATE_LIMIT" | "INVALID_ADDRESS" | "REJECTED" | "TIMEOUT" | "RENDER_ERROR" | "CONFIG_ERROR" | "UNKNOWN";
/**
...
type MailEvents = {
   ...
   */
  onSent?: (mail: MailOptions, result: MailResult | null, error: MailError | null) => void | Promise<void>;
  /**
...
declare class MailError extends Error {
  ...
  constructor(message: string, code: MailErrorCode, originalError?: Error);
}
//#endregion
export { CapturedMail, MailAddress, MailAttachment, MailConfigurations, MailError, MailErrorCode, MailEvents, MailMode, MailOptions, MailPriority, MailResult, MailersConfig, NormalizedMail, SESConfigurations, SMTPConfigurations };
