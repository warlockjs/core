 ...
 */
type ChunkCallback<T> = (documents: T[], chunkIndex: number) => Promise<false | any>;
/**
 * SQL-style where operators
 */
type WhereOperator = "=" | "!=" | "<>" | ">" | ">=" | "<" | "<=" | "like" | "not like" | "in" | "not in" | "between" | "not between";
/**
 * Repository-specific filter operators
 */
type FilterOperator = "bool" | "boolean" | "number" | "inNumber" | "null" | "notNull" | "!null" | "int" | "int>" | "int>=" | "int<" | "int<=" | "in" | "!int" | "integer" | "inInt" | "float" | "double" | "inFloat" | "date" | "inDate" | "date>" | "date>=" | "date<" | "date<=" | "dateBetween" | "dateTime" | "inDateTime" | "dateTime>" | "dateTime>=" | "dateTime<" | "dateTime<=" | "dateTimeBetween" | "location" | "scope" | "with" | "joinWith" | "similarTo" | WhereOperator;
/**
 * Filter function that receives value, query builder, and context
 */
type FilterFunction<M, Q = QueryBuilderContract<M>> = (value: any, query: Q, context: Record<string, any>) => void;
/**
 ...
 */
type FilterRule<Q = QueryBuilderContract<any>> = FilterOperator | FilterFunction<Q> | [FilterOperator] | [FilterOperator, string | string[]];
/**
 ...
 */
type PaginationMode = "pages" | "cursor";
/**
...
type RepositoryOptions = {
   ...
   */
  orderBy?: "random" | [string, "asc" | "desc"] | {
    [key: string]: "asc" | "desc";
  };
  /**
   * Sort by column name
 ...
 */
interface RepositoryOptionsWithPages extends RepositoryOptions {
  paginationMode?: "pages";
}
/**
 * Discriminated union type for cursor-based pagination options
 */
interface RepositoryOptionsWithCursor extends RepositoryOptions {
  paginationMode: "cursor";
}
/**
 * Options for cached repository operations
 */
type CachedRepositoryOptions = RepositoryOptions & {
  /**
 ...
 */
type AllRepositoryOptions = Omit<RepositoryOptions, "paginate" | "page">;
/**
 ...
 */
type TypedRepositoryOptions<F = Record<string, any>> = RepositoryOptions & Partial<F>;
/**
 ...
 */
type TypedAllRepositoryOptions<F = Record<string, any>> = AllRepositoryOptions & Partial<F>;
/**
 * Typed version of RepositoryOptionsWithPages with filter shape.
 * @template F - The filter shape defined by the repository
 */
type TypedRepositoryOptionsWithPages<F = Record<string, any>> = RepositoryOptionsWithPages & Partial<F>;
/**
 * Typed version of RepositoryOptionsWithCursor with filter shape.
 * @template F - The filter shape defined by the repository
 */
type TypedRepositoryOptionsWithCursor<F = Record<string, any>> = RepositoryOptionsWithCursor & Partial<F>;
/**
 * Repository event names
 */
type RepositoryEvent = "listing" | "list" | "creating" | "create" | "updating" | "update" | "saving" | "save" | "patching" | "patch" | "deleting" | "delete";
/**
 * Save mode for repository operations
 */
type SaveMode = "create" | "update" | "patch";
/**
...
//#endregion
export { AllRepositoryOptions, CachedRepositoryOptions, ChunkCallback, CursorPaginationOptions, CursorPaginationResult, FilterFunction, FilterOperator, FilterOptions, FilterRule, FilterRules, PaginationMode, PaginationResult, RepositoryConfigurations, RepositoryEvent, RepositoryOptions, RepositoryOptionsWithCursor, RepositoryOptionsWithPages, SaveMode, TypedAllRepositoryOptions, TypedRepositoryOptions, TypedRepositoryOptionsWithCursor, TypedRepositoryOptionsWithPages, WhereOperator };
