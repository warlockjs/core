...
//#region ../../@warlock.js/core/src/storage/types.d.ts
/**
 ...
 */
type CloudStorageDriverOptions = {
  /**
   * Bucket name
   */
  bucket: string;
 ...
 */
type R2StorageDriverOptions = Omit<CloudStorageDriverOptions, "region"> & {
  /**
 ...
 */
type CloudStorageFileData = StorageFileData & {
  /**
...
type PutDirectoryOptions = {
   ...
   */
  onProgress?: (uploaded: number, total: number, file: StorageFile) => void;
  /**
 ...
 */
type PresignedUploadOptions = PresignedOptions & {
  /**
   * File content type
   */
  contentType?: string;
 ...
 */
type TemporaryTokenError = "expired" | "invalid_signature" | "invalid_token" | "missing_key" | "file_not_found";
/**
 ...
 * Storage event types
 */
type StorageEventType = "beforePut" | "afterPut" | "beforeDelete" | "afterDelete" | "beforeCopy" | "afterCopy" | "beforeMove" | "afterMove";
/**
 ...
 * Put event payload
 */
type StoragePutEventPayload = StorageEventPayload & {
  /**
   * Storage file data
   */
 ...
 */
type StorageCopyEventPayload = StorageEventPayload & {
  /**
 ...
 */
type StorageEventHandler<T extends StorageEventPayload = StorageEventPayload> = (payload: T) => void | Promise<void>;
/**
...
type StorageDriverType = "local" | "s3" | "r2" | "spaces";
/**
 ...
 */
type StorageDriverName = keyof StorageDriverRegistry extends never ? string : keyof StorageDriverRegistry;
/**
 ...
 */
interface CloudStorageDriverContract extends StorageDriverContract {
  /**
 ...
 */
interface ScopedStorageContract {
  /**
 ...
 */
interface StorageManagerContract extends ScopedStorageContract {
  /**
