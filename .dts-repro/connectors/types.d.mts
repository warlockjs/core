//#region ../../@warlock.js/core/src/connectors/types.d.ts
/**
 * Connector Interface
...
type ConnectorName = "logger" | "mailer" | "http" | "database" | "cache" | "storage" | "communicator" | "socket" | (string & {});
/**
 ...
 */
declare enum ConnectorLifecyclePhase {
  Early = "early",
  Late = "late"
}
/**
 ...
 */
declare enum ConnectorPriority {
  LOGGER = 0,
  MAILER = 1,
  DATABASE = 2,
  COMMUNICATOR = 3,
