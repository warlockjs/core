 ...
 */
type PrefixConfig = boolean | string | PrefixOptions;
/**
 ...
 */
type FileNamingStrategy = "random" | "original" | (string & {});
/**
 ...
 */
type SaveAsOptions = Omit<SaveOptions, "name" | "prefix">;
/**
 ...
 * ```
 */
type ImageTransformCallback = (img: Image) => Image;
/**
 ...
 */
type ImageTransformConfig = ImageTransformOptions | ImageTransformCallback;
/**
...
//#endregion
export { FileNamingStrategy, ImageTransformCallback, ImageTransformConfig, PrefixConfig, PrefixOptions, SaveAsOptions, SaveOptions, UploadedFileImageOptions, UploadsConfigurations };
//# sourceMappingURL=uploads-types.d.mts.map