...
//#region ../../@warlock.js/core/src/router/types.d.ts
/**
 * Middleware response
 */
 ...
 */
type ResourceMethod = "list" | "get" | "create" | "update" | "delete" | "patch";
type RestfulMiddleware = Record<string, [Middleware]>;
...
type RequestMethod = "GET" | "POST" | "PUT" | "DELETE" | "PATCH" | "OPTIONS" | "HEAD" | "all";
/**
 * Route Object
 */
