 ...
 */
type CLICommandSource = "framework" | "plugin" | "project";
/**
...
type ResolvedCLICommandOption = Omit<CLICommandOption, "alias" | "name"> & {
  name: string;
  alias: string;
};
/**
 ...
 */
type CLICommandAction = (data: CommandActionData) => void | Promise<void>;
/**
...
//#endregion
export { CLICommandAction, CLICommandOption, CLICommandOptions, CLICommandPreload, CLICommandSource, CommandActionData, ResolvedCLICommandOption };
